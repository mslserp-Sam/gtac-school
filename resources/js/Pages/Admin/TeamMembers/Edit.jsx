            ...
            <div className="bg-white shadow rounded-md p-8">
                <form onSubmit={submit} encType="multipart/form-data">
                    ...
                    <div className="mb-4">
                        ...
                        {teamMember.image_path && !imagePreview && (
                            <div className="mb-4">
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">{teamMember.image_path}</p>
                            </div>
                        )}
                        ...
                        <div className="mb-2">
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                                Upload a new profile image (JPEG, PNG, GIF, or WebP, max 10MB). Recommended: Square image, minimum 400x400px
                            </p>
                        </div>
