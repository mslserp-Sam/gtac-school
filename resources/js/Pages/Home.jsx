...
export default function Home({ homePage, courses, galleryImages, vision, mission, about, teamMembers, homeSettings, latitude, longitude, address }) {
    ...
    return (
        <MainLayout>
            {/* Hero Section */}
            <section id="home" className="relative min-h-screen flex items-center justify-center text-white overflow-hidden parallax-section" style={{ backgroundImage: `url(${settings.hero_background_image || '/images/homeBg.jpg'})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
